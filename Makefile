...
#COMAKE UUID
COMAKE_MD5=676dc64b4aa80d5ccc6b51944897efe0  COMAKE
...
clean:ccpclean
	...
	rm -rf src/Trainers/melt_trainers_EnsembleTrainer.o
	rm -rf src/Trainers/melt_trainers_Gbdt.o
	rm -rf src/Trainers/melt_trainers_LibLinearTrainer.o
	rm -rf src/Trainers/melt_trainers_LibSVMTrainer.o
	...
	rm -rf src/Run/melt_trainers_Melt.o
...
libmelt_trainers.a:src/Trainers/melt_trainers_EnsembleTrainer.o \
  src/Trainers/melt_trainers_Gbdt.o \
  src/Trainers/melt_trainers_LibLinearTrainer.o \
  src/Trainers/melt_trainers_LibSVMTrainer.o \
  ...
  src/Run/melt_trainers_Melt.o
	@echo "[[1;32;40mCOMAKE:BUILD[0m][Target:'[1;32;40mlibmelt_trainers.a[0m']"
	ar crs libmelt_trainers.a src/Trainers/melt_trainers_EnsembleTrainer.o \
  src/Trainers/melt_trainers_Gbdt.o \
  src/Trainers/melt_trainers_LibLinearTrainer.o \
  src/Trainers/melt_trainers_LibSVMTrainer.o \
  src/Trainers/melt_trainers_LinearSVM.o \
...
src/Trainers/melt_trainers_EnsembleTrainer.o:src/Trainers/EnsembleTrainer.cpp
	@echo "[[1;32;40mCOMAKE:BUILD[0m][Target:'[1;32;40msrc/Trainers/melt_trainers_EnsembleTrainer.o[0m']"
	$(CXX) -c $(INCPATH) $(DEP_INCPATH) -D_GNU_SOURCE \
  -D__STDC_LIMIT_MACROS \
  -DVERSION=\"1.9.8.7\" \
  -O3 \
  -DNDEBUG $(CXXFLAGS)  -o src/Trainers/melt_trainers_EnsembleTrainer.o src/Trainers/EnsembleTrainer.cpp

src/Trainers/melt_trainers_Gbdt.o:src/Trainers/Gbdt.cpp
	@echo "[[1;32;40mCOMAKE:BUILD[0m][Target:'[1;32;40msrc/Trainers/melt_trainers_Gbdt.o[0m']"
	$(CXX) -c $(INCPATH) $(DEP_INCPATH) -D_GNU_SOURCE \
  -D__STDC_LIMIT_MACROS \
  -DVERSION=\"1.9.8.7\" \
  -O3 \
  -DNDEBUG $(CXXFLAGS)  -o src/Trainers/melt_trainers_Gbdt.o src/Trainers/Gbdt.cpp
...
src/Trainers/melt_trainers_LibSVMTrainer.o:src/Trainers/LibSVMTrainer.cpp
	@echo "[[1;32;40mCOMAKE:BUILD[0m][Target:'[1;32;40msrc/Trainers/melt_trainers_LibSVMTrainer.o[0m']"
	$(CXX) -c $(INCPATH) $(DEP_INCPATH) -D_GNU_SOURCE \
  -D__STDC_LIMIT_MACROS \
  -DVERSION=\"1.9.8.7\" \
  -O3 \
  -DNDEBUG $(CXXFLAGS)  -o src/Trainers/melt_trainers_LibSVMTrainer.o src/Trainers/LibSVMTrainer.cpp
...
src/Run/melt_trainers_Melt.o:src/Run/Melt.cpp
	@echo "[[1;32;40mCOMAKE:BUILD[0m][Target:'[1;32;40msrc/Run/melt_trainers_Melt.o[0m']"
	$(CXX) -c $(INCPATH) $(DEP_INCPATH) -D_GNU_SOURCE \
  -D__STDC_LIMIT_MACROS \
  -DVERSION=\"1.9.8.7\" \
  -O3 \
  -DNDEBUG $(CXXFLAGS)  -o src/Run/melt_trainers_Melt.o src/Run/Melt.cpp
